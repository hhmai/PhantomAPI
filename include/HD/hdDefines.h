...
#define HD_VERSION_MINOR_NUMBER            30      
#define HD_VERSION_BUILD_NUMBER            0
...
#define HD_DEFAULT_SCHEDULER_PRIORITY      ((HD_MAX_SCHEDULER_PRIORITY + HD_MIN_SCHEDULER_PRIORITY)/2)      
